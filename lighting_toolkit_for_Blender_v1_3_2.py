...
class EDIT_OT_MakeLinks(Operator):
    bl_idname = 'lamp.make_links_lookdev'
    bl_label = 'Add objects to Lookdev'
    bl_options = {"REGISTER", "UNDO"}
        
    def execute(self, context):
        for i in bpy.context.selected_objects:
            bpy.ops.object.make_links_scene(scene='Lookdev')
...
class EDIT_PT_LightingToolkit(Panel):
    ...
    def draw(self, context):
        #self.layout.operator("lamp.make_links_lookdev", text="Add objects to Lookdev")
        #self.layout.separator()
